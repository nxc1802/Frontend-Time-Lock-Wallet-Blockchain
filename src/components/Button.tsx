...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    outline: 'border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 focus:ring-gray-500 dark:border-gray-600 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-300',
  };
  ...
  return (
    ...
    >
      {loading && (
        <svg
          className={classNames('animate-spin -ml-1 mr-2', spinnerSizes[size])}
